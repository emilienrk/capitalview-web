...
import { ArrowUpDown, Bitcoin, CreditCard, Home, Landmark, LogOut, Menu, Microscope, NotebookPen, PiggyBank, Settings, TrendingUp, Users } from 'lucide-vue-next'

...
<template>
  <div class="min-h-screen flex flex-col">
    ...
    <nav v-if="auth.isAuthenticated" class="px-6 py-4 bg-surface dark:bg-surface-dark border-b border-surface-border dark:border-surface-dark-border shadow-sm flex flex-wrap gap-6 items-center sticky top-0 z-50">
      ...
      <div class="flex-1 flex gap-4 overflow-x-auto items-center text-sm font-medium">
        <router-link to="/" class="hover:text-primary transition-colors" active-class="text-primary font-bold">Dashboard</router-link>
